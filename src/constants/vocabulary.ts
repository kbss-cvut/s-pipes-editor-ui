...
export const PIPELINE_EXECUTION_START_DATE = `${S_PIPES}/has-pipeline-execution-start-date-unix`;
export const PIPELINE_EXECUTION_FINISH_DATE = `${S_PIPES}/has-pipeline-execution-finish-date-unix`;
...
export const SCRIPT_TYPE = `${S_PIPES}/has-type`;
export const SCRIPT_RETURN_MODULE_NAME = `${S_PIPES}/has-return-module-name`;
export const SCRIPT_FUNCTION_NAME = `${S_PIPES}/has-function-name`;
export const SCRIPT_FUNCTION_ARGUMENTS = `${S_PIPES}/has-function-arguments`;
export const SCRIPT_FUNCTION_ARGUMENT = `${S_PIPES}/script-function-argument`;
export const SCRIPT_FUNCTION_ARGUMENT_NAME = `${S_PIPES}/has-function-argument-name`;
export const SCRIPT_FUNCTION_ARGUMENT_LABEL = `${S_PIPES}/has-function-argument-label`;
export const SCRIPT_FUNCTION_ARGUMENT_COMMENT = `${S_PIPES}/has-function-argument-comment`;
