            ...
            return (
                ...
                >
                    <Modal.Header closeButton>
                        <Modal.Title>Function execution:<br/>{this.state.functionUri}</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        <Form>
                            <Form.Group controlId="exampleForm.Textarea" onSubmit={this.handleSubmit}>
                                <Form.Label>Function parameters</Form.Label>
                                <Form.Control onChange={(e) => this.setState({params: e.target.value})} as="textarea" placeholder='firstName=Robert&lastName=Plant' rows={3} />
                            </Form.Group>
                        </Form>
                    </Modal.Body>
                    <Modal.Footer>
