                    ...
                    <Modal.Body>
                        <Container>
                            ...
                            {this.state.ontologies.map((data, key) => {
                                return (
                                    <Row key={key}>
                                        <Col><Alert variant="info">{data}</Alert></Col>
                                        <Col><Alert onClick={() => this.handleRemoveOntology(data)} variant="danger" style={{cursor: 'pointer'}}>REMOVE</Alert></Col>
                                    </Row>
                                );
                            })}
